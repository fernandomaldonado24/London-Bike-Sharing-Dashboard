...
A custom Power Query function using **M code** was developed to create a flexible and reusable date table. This function includes various time segments—weeks, start of week, months, start of month, etc.—to support flexible time slicing for analysis.
...
Simple, focused metrics were developed for the report. The image below includes the calculation of **Average Rides on Non-Holidays**, which was used in a KPI card.
